...
public class LexerATNSimulator extends ATNSimulator {
  ...
  @Nullable protected final Lexer recog;
  ...
  @NotNull public final DFA[] dfa;

  protected int mode = Lexer.DEFAULT_MODE;

  /** Used during DFA/ATN exec to record the most recent accept configuration info */
  @NotNull protected final ExecState prevAccept = new ExecState();
  ...
  protected int execATN(@NotNull CharStream input, @NotNull ATNConfigSet s0, @Nullable DFAState ds0) {
    @NotNull ATNConfigSet closure = s0;
    if (debug) {
  ...
  protected void processAcceptStates(@NotNull CharStream input, @NotNull ATNConfigSet reach) {
    for (int ci = 0; ci < reach.size(); ci++) {
      ...
      if (c.state instanceof RuleStopState) {
        ...
        deleteWildcardConfigsForAlt(reach, ci, c.alt);
      }
    }
  }
  ...
  @Nullable public ATNState getReachableTarget(Transition trans, int t) {
    if (trans instanceof AtomTransition) {
      ...
      if (trans.getClass() == RangeTransition.class) {
        ...
        if (trans instanceof SetTransition) {
          ...
          if (trans instanceof WildcardTransition && t != CharStream.EOF) {
            return trans.target;
          }
        }
      }
  ...
  @NotNull protected ATNConfigSet computeStartState(@NotNull IntStream input, @NotNull ATNState p) {
  ...
  @Nullable public ATNConfig getEpsilonTarget(@NotNull ATNConfig config, @NotNull Transition t) {
    ATNState p = config.state;
    ATNConfig c = null;
    if (t.getClass() == RuleTransition.class) {
      ...
      if (t.getClass() == PredicateTransition.class) {
        if (recog == null) {
        ...
        if (t.getClass() == ActionTransition.class) {
  ...
  protected void addDFAEdge(@NotNull DFAState p, int t, @NotNull DFAState q) {
    ...
    if (p.edges == null) {
      p.edges = new DFAState[MAX_DFA_EDGE + 1];
    }
    p.edges[t] = q;
  }
  ...
  /** Add a new DFA state if there isn't one with this set of
	 ...
	 */
  @Nullable protected DFAState addDFAState(@NotNull ATNConfigSet configs) {
  ...
  @Nullable public DFA getDFA(int mode) {
    return dfa[mode];
  }
