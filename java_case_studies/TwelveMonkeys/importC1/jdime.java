...
>>>>>>> Unknown file: This is a bug in JDime.
  ...
  @Override public boolean write(final Directory directory, final ImageOutputStream stream) throws IOException {
  ...
  public void writeOffset(final ImageOutputStream output, long offset) throws IOException {
    if (longOffsets) {
      ...
      output.writeInt(assertIntegerOffset(offset));
    }
  }
