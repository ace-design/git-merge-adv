...
class AlternatorDBHandler {
  ...
  protected GetItemResult getItem(GetItemRequest request) throws InternalServerErrorException, ResourceNotFoundException {
    ...
    if (key.getHashKeyElement().getS() != null) {
      ...
      if (key.getHashKeyElement().getN() != null) {
...
>>>>>>> right.java
  ...
  private void EQHandle(List<Map<String, AttributeValue>> items, Map<String, AttributeValue> item, 
<<<<<<< left.java
...
>>>>>>> right.java
  ...
  private void GTHandle(List<Map<String, AttributeValue>> items, Map<String, AttributeValue> item, 
<<<<<<< left.java
  AttributeValue attributeValue
=======
  Condition cond
...
>>>>>>> right.java
  ...
  private void LTHandle(List<Map<String, AttributeValue>> items, Map<String, AttributeValue> item, 
<<<<<<< left.java
  AttributeValue attributeValue
=======
  Condition cond
