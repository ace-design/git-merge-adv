...
public abstract class WebSocketClient extends AbstractWebSocket implements Runnable, WebSocket {
  ...
  public WebSocketClient(URI serverUri, Draft protocolDraft, Map<String, String> httpHeaders, int connectTimeout) {
    ...
    this.dnsResolver = new DnsResolver() {
      @Override public InetAddress resolve(URI uri) throws UnknownHostException {
  ...
  @Override public <T extends java.lang.Object> T getAttachment() {
    return engine.getAttachment();
  }

  @Override public <T extends java.lang.Object> void setAttachment(T attachment) {
    engine.setAttachment(attachment);
  }

  @Override protected Collection<WebSocket> getConnections() {
  ...
  /**
	 ...
	 */
  @Deprecated public void setSocket(Socket socket) {
    if (this.socket != null) {
