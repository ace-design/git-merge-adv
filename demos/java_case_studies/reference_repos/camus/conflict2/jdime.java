...
public class EtlInputFormat extends InputFormat<EtlKey, CamusWrapper> {
  ...
  private public static final int 
<<<<<<< left.java
  RETRY_TIMES = 1
=======
...
>>>>>>> right.java
  ...
  private public static final int 
<<<<<<< left.java
  BACKOFF_UNIT_MILLISECONDS = 1000
=======
  NUM_TRIES_TOPIC_METADATA = 3
>>>>>>> right.java
  ;
          ...
          if (!createMessageDecoder(context, topicMetadata.topic())) {
            ...
            if (topicMetadata.errorCode() != ErrorMapping.NoError()) {
              ...
              for (PartitionMetadata partitionMetadata : topicMetadata.partitionsMetadata()) {
                partitionMetadata = this.refreshPartitionMetadataOnLeaderNotAvailable(partitionMetadata, topicMetadata, context, RETRY_TIMES);
  ...
  public PartitionMetadata refreshPartitionMetadataOnLeaderNotAvailable(PartitionMetadata partitionMetadata, TopicMetadata topicMetadata, JobContext context, int retryTimes) throws InterruptedException {
    int retryCounter = 0;
