 ...
 * </ol>
 */
@API(status = API.Status.STABLE) public final class TestNGCucumberRunner {
  ...
  public TestNGCucumberRunner(Class clazz) {
    ...
    RuntimeOptions annotationOptions = new CucumberOptionsAnnotationParser(resourceLoader).withOptionsProvider(new TestNGCucumberOptionsProvider()).parse(clazz).build(propertiesFileOptions);
    ...
    runtimeOptions = new CucumberPropertiesParser(resourceLoader).parse(CucumberProperties.fromSystemProperties()).build(environmentOptions);
