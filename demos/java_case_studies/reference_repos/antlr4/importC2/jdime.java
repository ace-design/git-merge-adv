...
public class ParserATNFactory implements ATNFactory {
  ...
  @Override public void setCurrentRuleName(String name) {
    this.currentRule = g.getRule(name);
  }

  @Override public void setCurrentOuterAlt(int alt) {
    currentOuterAlt = alt;
  }

  @Override public Handle rule(GrammarAST ruleAST, String name, Handle blk) {
  ...
  @Override public Handle tokenRef(TerminalAST node) {
  ...
  /** From set build single edge graph {@code o->o-set->o}.  To conform to
     ...
     */
  @Override public Handle set(GrammarAST associatedAST, List<GrammarAST> terminals, boolean invert) {
  ...
  @Override public Handle range(GrammarAST a, GrammarAST b) {
  ...
  @Override public Handle stringLiteral(TerminalAST stringLiteralAST) {
    return tokenRef(stringLiteralAST);
  }

  /** {@code [Aa]} char sets not allowed in parser */
  @Override public Handle charSetLiteral(GrammarAST charSetAST) {
    return null;
  }
  ...
  /**
	 ...
	 */
  @Override public Handle ruleRef(GrammarAST node) {
  ...
  @Override public Handle epsilon(GrammarAST node) {
    ATNState left = newState(node);
    ATNState right = newState(node);
    epsilon(left, right);
    node.atnState = left;
  ...
  /** Build what amounts to an epsilon transition with a semantic
	 ...
	 */
  @Override public Handle sempred(PredAST pred) {
  ...
  /** Build what amounts to an epsilon transition with an action.
	 ...
	 */
  @Override public Handle action(ActionAST action) {
  ...
  @Override public Handle action(String action) {
    return null;
  }
  ...
  /**
	 ...
	 */
  @Override public Handle block(BlockAST blkAST, GrammarAST ebnfRoot, List<Handle> alts) {
    if (ebnfRoot == null) {
      if (alts.size() == 1) {
        Handle h = alts.get(0);
  ...
  @NotNull @Override public Handle alt(@NotNull List<Handle> els) {
    return elemList(els);
  }

  @NotNull public Handle elemList(@NotNull List<Handle> els) {
    int n = els.size();
    for (int i = 0; i < n - 1; i++) {
      Handle el = els.get(i);
      Transition tr = null;
  ...
  /**
	 ...
	 * block
	 */
  @NotNull @Override public Handle optional(@NotNull GrammarAST optAST, @NotNull Handle blk) {
  ...
  /**
	 ...
	 * start.
	 */
  @NotNull @Override public Handle plus(@NotNull GrammarAST plusAST, @NotNull Handle blk) {
  ...
  /**
	 ...
	 */
  @NotNull @Override public Handle star(@NotNull GrammarAST starAST, @NotNull Handle elem) {
  ...
  @NotNull @Override public Handle wildcard(GrammarAST node) {
    ATNState left = newState(node);
    ATNState right = newState(node);
  ...
  @Override public Handle label(Handle t) {
    return t;
  }

  @Override public Handle listLabel(Handle t) {
    return t;
  }

  @NotNull public <T extends ATNState> T newState(@NotNull Class<T> nodeType, GrammarAST node) {
    Exception cause;
    try {
  ...
  @NotNull @Override public ATNState newState() {
  ...
  @Override public Handle lexerAltCommands(Handle alt, Handle cmds) {
    return null;
  }

  @Override public String lexerCallCommand(GrammarAST ID, GrammarAST arg) {
    return null;
  }

  @Override public String lexerCommand(GrammarAST ID) {
    return null;
  }
}