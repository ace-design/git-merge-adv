...
public class ApplicationAssert implements AssertExtension {
  ...
  public ApplicationAssert hasEmbeddedCartridges(LatestEmbeddableCartridge... selectors) throws OpenShiftException {
  ...
  public ApplicationAssert hasEmbeddedCartridge(LatestEmbeddableCartridge selector) throws OpenShiftException {
    hasEmbeddedCartridge(selector.get(application));
    return this;
  }

  public ApplicationAssert hasEmbeddedCartridge(IEmbeddableCartridge... cartridges) throws OpenShiftException {
  ...
  public ApplicationAssert hasEmbeddedCartridge(IEmbeddableCartridge cartridge) throws OpenShiftException {
  ...
  public ApplicationAssert hasResultFieldOrResultSeverityMessage() throws IOException {
    ...
    if (matchingMessages == null || matchingMessages.isEmpty()) {
