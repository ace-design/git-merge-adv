...
public class UrlConnectionHttpClient implements IHttpClient {
  ...
  private String setupUserAgent(String authKey, String authIV, String userAgent) {
    if (!StringUtils.isEmpty(authKey)) {
      if (userAgent == null) {
        ...
        if (!userAgent.startsWith("OpenShift")) {
  ...
  @Override public void setAcceptedMediaType(String acceptedMediaType) {
    this.acceptedMediaType = acceptedMediaType;
  }

  @Override public String getAcceptedMediaType() {
  ...
  @Override public String get(URL url) throws HttpClientException, SocketTimeoutException {
  ...
  @Override public String get(URL url, int timeout) throws HttpClientException, SocketTimeoutException {
...
>>>>>>> right.java
  ...
  @Override public void setAcceptVersion(String version) {
    this.acceptVersion = version;
  }

  @Override public String getAcceptVersion() {
...
>>>>>>> right.java
  ...
  @Override public String put(Map<String, Object> parameters, URL url, 
<<<<<<< left.java
...
>>>>>>> right.java
  ...
  @Override public String put(URL url, int timeout, 
<<<<<<< left.java
  RequestParameter... parameters
=======
...
>>>>>>> right.java
    ...
    return 
<<<<<<< left.java
    request(HttpMethod.PUT, url, timeout, parameters)
=======
    write(mediaType.encodeParameters(parameters), HttpMethod.PUT.toString(), url, timeout, mediaType)
>>>>>>> right.java
    ;
  }

  protected String put(String data, URL url, RequestParameter... parameters) throws HttpClientException, SocketTimeoutException {
    return 
<<<<<<< left.java
    request(HttpMethod.PUT, url, NO_TIMEOUT, parameters)
=======
    write(data, HttpMethod.PUT.toString(), url, NO_TIMEOUT, requestMediaType)
>>>>>>> right.java
    ;
  }

  @Override public String post(URL url, RequestParameter... parameters) throws SocketTimeoutException, EncodingException, HttpClientException {
...
>>>>>>> right.java
  ...
  @Override public String post(Map<String, Object> parameters, URL url, int timeout, 
<<<<<<< left.java
  RequestParameter... parameters
=======
  IMediaType mediaType
>>>>>>> right.java
    ...
    return 
<<<<<<< left.java
    request(HttpMethod.POST, url, timeout, parameters)
=======
    write(mediaType.encodeParameters(parameters), HttpMethod.POST.toString(), url, timeout, mediaType)
>>>>>>> right.java
    ;
  }
...
>>>>>>> right.java
  ...
  @Override public String delete(Map<String, Object> parameters, URL url, 
<<<<<<< left.java
  RequestParameter... parameters
=======
  int timeout
>>>>>>> right.java
    ...
    return 
<<<<<<< left.java
    request(HttpMethod.DELETE, url, NO_TIMEOUT, parameters)
=======
    delete(parameters, url, timeout, requestMediaType)
>>>>>>> right.java
    ;
  }

  @Override public String delete(URL url, int timeout, 
<<<<<<< left.java
  RequestParameter... parameters
=======
  IMediaType mediaType
>>>>>>> right.java
    ...
    return 
<<<<<<< left.java
    request(HttpMethod.DELETE, url, timeout, parameters)
=======
    write(mediaType.encodeParameters(parameters), HttpMethod.DELETE.toString(), url, timeout, mediaType)
>>>>>>> right.java
    ;
  }

  @Override public String delete(URL url) throws HttpClientException, SocketTimeoutException, UnsupportedEncodingException {
    return delete(url, NO_TIMEOUT);
  }

  protected String request(HttpMethod httpMethod, URL url, int timeout, RequestParameter... parameters) throws SocketTimeoutException, HttpClientException {
...
>>>>>>> right.java
  ...
  private void setAcceptHeader(HttpURLConnection connection) {
    ...
    if (acceptVersion != null) {
      builder.append(SEMICOLON).append(SPACE).append(VERSION).append(EQUALS).append(acceptVersion);
    }
  ...
  private void setAuthorisation(String username, String password, String authKey, String authIV, HttpURLConnection connection) {
    if (username == null || username.trim().length() == 0 || password == null || password.trim().length() == 0) {
      ...
      String credentials = Base64Coder.encode(new StringBuilder().append(username).append(COLON).append(password).toString().getBytes());
      connection.setRequestProperty(PROPERTY_AUTHORIZATION, new StringBuilder().append(AUTHORIZATION_BASIC).append(SPACE).append(credentials).toString());
    }
  }

  private void setSSLChecks(URL url, HttpURLConnection connection) {
    if (isHttps(url) && !sslChecks) {
  ...
  private void setConnectTimeout(URLConnection connection) {
    int timeout = getTimeout(getSystemPropertyInteger(SYSPROP_OPENSHIFT_CONNECT_TIMEOUT), getSystemPropertyInteger(SYSPROP_DEFAULT_CONNECT_TIMEOUT), DEFAULT_CONNECT_TIMEOUT);
