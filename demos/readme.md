...
* 9 Deletions: Every package in desired version is present in the result.
* 100 insertions: Extra packages present in the result that are not there in the desired.
* 143 Moves: Number of import statements in the result that are in a different spot from desired.
